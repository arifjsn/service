...
use App\Mail\ApproveClaimGaransiMailer;
use App\Mail\RejectClaimGaransiMailer;

class ClaimGaransiController extends Controller
{
    public function index(Request $request): View
    {
        $claimGaransi = ClaimGaransi::latest()
            ->when($request->pencarian, function ($query, $pencarian) {
                return $query->whereLike(['nama', 'nomor_hp', 'model_barang', 'jenis_barang', 'tanggal_pembelian', 'status'], $pencarian);
            })
        ...
        return view('admin.claim-garansi.index', [
