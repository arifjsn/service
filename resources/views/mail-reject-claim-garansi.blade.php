                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            ...
                                            <p>Mohon maaf! Claim Garansi Produk {{ $userData['brand'] !== 'ESR' ? ucfirst(strtolower($userData['brand'])) : $userData['brand'] }} Anda dengan Nomor Garansi '{{ $userData['nomor_garansi'] }}' tidak disetujui.</p>
